function [lgraph,pximds,options]=setupAugmenter(imds,pxds,imageSize,numClasses,value,TypeOfAnalysis,TypeOfAugmenter)
 ...
 if strcmp(TypeOfAnalysis,'partial')
     if strcmp(TypeOfAugmenter,'rotation')
       ...
       if strcmp(TypeOfAugmenter,'traslation')
        augmenter = imageDataAugmenter('RandRotation',[0 360],'RandXReflection',true,'RandXTranslation',value,'RandYTranslation',value);       
       end      
 end
